...
class ApiController extends AbstractController
{
     ...
     * @return JsonResponse
     */
    public function search(Request $request, RutrackerClient $client) : JsonResponse{
        $q = $request->get('q');
     ...
     * @return JsonResponse
     */
    public function download(Request $request, RutrackerClient $client) : JsonResponse{
